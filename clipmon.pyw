...
class ClipMonFrame (wx.Frame):
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(self, id=wxID_FRAME1, name='', parent=prnt, size=wx.Size(300, 400), style=wx.DEFAULT_FRAME_STYLE, title=u'Clipboard Monitor...')
        ...
        self.button1 = wx.Button(id=wxID_FRAME1BTN_CLEAR, label=u'Clear item', name='button1', parent=self, pos=wx.Point(5, 365),
